...
| Space groups | only a repository's worktrees, grouped automatically | named groups of any spaces: "move to group..." on a space lists the groups (or makes one, or leaves one), and a space dragged onto a group's heading or among its spaces joins it | the owner asked for spaces to be put together by hand |
