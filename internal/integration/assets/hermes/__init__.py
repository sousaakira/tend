"""Hermes plugin installed by tend to report resumable session identity."""

# TEND_INTEGRATION_ID=hermes
# TEND_INTEGRATION_VERSION=5
...
def _pane_id() -> str | None:
    if os.environ.get("TEND_ENV") != "1":
        return None
    return os.environ.get("TEND_PANE_ID", "").strip() or None
